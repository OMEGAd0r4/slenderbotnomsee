...
class truthordareCommand extends commando.Command {
    ...
    async run(message, args)
    {
        ...
        var truthoption = ["Have you ever tried to kill a friend?", "What is your darkest secret?", "Have you ever cheated during an exam?", "What’s the dumbest thing you ever said or did, around a boy/girl you liked?", "Do you bite your toe nails?", "What was your most embarrassing farting moment?", "Have you ever broken something and blamed someone else?", "No truth, do the dare", "Do the dare", "Dare time", "The dare is calling you out"]
